<footer class="full-row bg-secondary p-0">
    <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-4">
                            <div class="footer-widget mb-4">
                                <div class="footer-logo mb-4"> <a href="#"><img class="logo-bottom" src="images/logo/restatelg_white.png" alt="image" style="width: 10%;"></a> </div>
                                <p class="pb-20 text-white">To help our clients find their perfect home by delivering exceptional service, expert guidance, and trustworthy real estate solutions. We are committed to integrity, professionalism, and building lasting relationships in every transaction.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-4">
                                    <div class="footer-widget">
                                        ...
                                        <ul class="text-white">
                                            <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>KM 46 Lagos - Ibadan Expressway, Redemption City, Mowe, Ogun State, Nigeria.</li>
                                            <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+234 734-567-8910</li>
                                            <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+234 813-765-4321</li>
        ...
        <div class="row copyright">
            <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y'); ?> Real Estate Website - ND project</span> </div>
            <div class="col-sm-6">
