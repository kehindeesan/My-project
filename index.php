                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <p>We offer the best sales when it comes to property their prices</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <p>Our rental service offers the best price and quality</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <p>Properties are always in their best condition before being listed.</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <p>All investment made are made are legal and wont put you at the wrong side of the law.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <ul>
                                    <li class="mb-4 text-white d-flex">
                                        ...
                                        <div class="pl-2">
                                            ...
                                            <p>We’re consistently recognized as one of the highest-rated real estate teams in the area, thanks to our dedication to client satisfaction, market expertise, and seamless transactions.</p>
                                        </div>
                                    </li>
                                    <li class="mb-4 text-white d-flex">
                                        ...
                                        <div class="pl-2">
                                            ...
                                            <p>From first-time buyers to seasoned investors, we provide personalized, high-touch service to ensure every client finds the perfect property—and enjoys a smooth, stress-free experience.</p>
                                        </div>
                                    </li>
                                    <li class="mb-4 text-white d-flex">
                                        ...
                                        <div class="pl-2">
                                            ...
                                            <p>Our team brings years of local market knowledge, negotiation skills, and industry insights to the table, helping you make confident decisions and maximize your investment.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="icon-thumb-one text-center mb-5">
                                ...
                                <h5 class="text-secondary mt-5 mb-4">Let’s Talk Real Estate</h5>
                                <p>Tell us your vision, and we’ll craft a tailored plan—whether it’s finding your dream home or selling for top Price.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="icon-thumb-one text-center mb-5">
                                ...
                                <h5 class="text-secondary mt-5 mb-4">Your Perfect Match</h5>
                                <p>We’ll handpick properties that fit your lifestyle and budget, so you don’t waste time on listings that don’t work.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="icon-thumb-one text-center mb-5">
                                ...
                                <h5 class="text-secondary mt-5 mb-4">Keys in Hand</h5>
                                <p>Our team manages the fine print, ensuring a hassle-free closing and celebrating your success with you.</p>
                            </div>
                        </div>
                    </div>
                </div>
