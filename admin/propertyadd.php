...
{	
	...
	'$loc','$city','$state','$feature','$aimage','$aimage1','$aimage2','$aimage3','$aimage4','40','$status','$fimage','$fimage1','$fimage2','$totalfloor','$isFeatured')";
									...
									<?php echo $msg; ?>
										...
										<div class="row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">info</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="" required placeholder="Info">
													</div>
												</div>
												<div class="form-group row">
